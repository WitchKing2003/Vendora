...
const AccountSidebar = () => {
  ...
  const items = [
    { icon: "M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM4 21c1.5-4 4.4-6 8-6s6.5 2 8 6", labelKey: "account.profile", active: false },
    { icon: "M4 10l8-6 8 6v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-9zM9 21v-6h6v6", labelKey: "tracking.myOrders", active: true },
    { icon: "M5 21V8a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v13M3 21h18", labelKey: "account.addresses", active: false },
    { icon: "M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.7l-1-1.1a5.5 5.5 0 0 0-7.8 7.8l1 1L12 21l7.8-7.6 1-1a5.5 5.5 0 0 0 0-7.8Z", labelKey: "account.wishlist", active: false },
    { icon: "M4 7h16l-1.5 13h-13L4 7zM9 7V5a3 3 0 0 1 6 0v2", labelKey: "account.vouchers", active: false },
    { icon: "M12 17.3l-6.2 3.7 1.7-7L2 9.2l7.2-.6L12 2l2.8 6.6 7.2.6-5.5 4.8 1.7 7z", labelKey: "account.reviews", active: false },
  ];
  return (
        ...
        {items.map((item) => (
          <span
            ...
            className={`flex items-center gap-3 px-4 py-3.5 text-sm ${
              item.active ? "bg-ink font-bold text-white" : "font-medium text-ink/80"
            }`}
          >
